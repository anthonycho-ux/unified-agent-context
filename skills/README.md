...
| Claude Code (Mac + store-host) | `~/.claude/skills/` |
| Codex primary / secondary | `~/.codex/skills/`, `~/.codex-secondary/skills/` |
| shared agents dir | `~/.agents/skills/` |
| gjc | `~/.gjc/skills/` |
| Hermes (store-host) | `~/.hermes/skills/<category>/` — check name collisions first |
| Letta Code (store-host) | `~/.letta/skills/` (global) — NOT `~/.agents/skills` |
