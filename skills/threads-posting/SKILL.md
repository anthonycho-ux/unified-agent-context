...
- Delivery: keep the brief in the session chat unless the user has asked for Telegram push; a push goes through the Hermes Telegram path (hermes send --to telegram on sov), never a new Aside routine.
